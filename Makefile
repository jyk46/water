...
shallow: driver.cc LocalState.h central2d.h shallow2d.h minmod.h meshio.h
	$(CXX) $(CXXFLAGS) -D_SERIAL -o $@ $<

shallow-pnode: driver.cc LocalState.h central2d_pnode.h shallow2d.h minmod.h meshio.h
	$(CXX) $(CXXFLAGS) -D_PARALLEL_NODE -o $@ $<

shallow-pdevice: driver.cc LocalState.h central2d_pdevice.h shallow2d.h minmod.h meshio.h
